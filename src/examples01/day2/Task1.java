 ...
 * Релизовать программу, которая принимает на вход через консоль с помощью класса Scanner,
 * число, соответствующее количеству этажей в здании.
 * Использую условный оператор if, необходимо вывести в консоль сообщение о типе такого дома
 *
 * Условия: если жтажей 1-4 - "Малоэтажный дом", 5-8 - "Среднеэтажный дом", 9 и более - "Многоэтажный дом"
